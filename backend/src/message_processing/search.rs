...
pub fn logic(id: NumId, myself: Peer, metadata: &mut SearchMetadata, local_hosts: &HashMap<String, SocketAddrV4>) -> (Peer, Option<EarlyReturnContext>, Option<Duration>, PropagationDirection) {
